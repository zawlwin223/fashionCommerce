...
var _view = require("./view"); // console.log('Hello World')
var _viewDefault = parcelHelpers.interopDefault(_view);

},{"./model":"Y4A21","./view":"ky8MP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports,__globalThis) {
...
},{}],"ky8MP":[function(require,module,exports,__globalThis) {
// const hero = document.querySelector('.hero')
// const promotion = document.querySelector('.promotion')
// const repairService = document.querySelector('.repair-service')
// const service = document.querySelector('.service')
// console.log(hero, promotion, service, repairService)
